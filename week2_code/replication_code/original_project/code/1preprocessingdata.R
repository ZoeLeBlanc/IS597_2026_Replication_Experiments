...
#### Read data & clean column names #### Needed to change paths
jjtheory <- read_csv("data/1_JJ_theor_.csv")
nntheory <- read_csv("data/1_NN_theor_.csv")
theory <- read_csv("data/1_theor_of_normalized.csv")
...
write_csv(unique_theoriesof, "data/1_theoriesof_complete_rerun.csv")
